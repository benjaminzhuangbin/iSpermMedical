# Nexus ADB Watchdog 2.2 - PowerShell installer (LF-safe)
# Usage:
...
Write-Host "============================================================"
Write-Host " Nexus ADB Watchdog 2.2 - install.ps1"
Write-Host "============================================================"
...
if (-not (Test-Path -LiteralPath $Binary)) {
    ...
    Write-Host "Copy the whole NexusADBWatchdog-2.2 folder including release\watchdog"
    exit 1
}
...
Write-Host ""
Write-Host "[OK] Install complete - Version 2.2"
