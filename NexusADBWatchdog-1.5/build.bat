@echo off
REM ============================================================================
REM Nexus ADB Watchdog 1.5 - build.bat
...
echo ============================================================
echo  Nexus ADB Watchdog 1.5 - Android NDK build
echo ============================================================
...
if errorlevel 1 (
    echo.
    echo [WARN] Ninja generator failed; retrying with MinGW Makefiles...
    if exist "%BUILD_DIR%" rmdir /s /q "%BUILD_DIR%"
    mkdir "%BUILD_DIR%"
...
echo.
echo [OK] Build complete - Nexus ADB Watchdog 1.5
