@echo off
REM ============================================================================
REM Nexus ADB Watchdog 1.5 - install.bat
...
echo ============================================================
echo  Nexus ADB Watchdog 1.5 - install
echo ============================================================
...
echo.
echo [1/6] Stopping previous watchdog if running (monitor binary only)...
REM Stop only our watchdog process via its PID file. Never touch adbd.
...
echo.
echo [OK] Install complete - Version 1.5
echo.
...
echo.
echo NOTE: Version 1.5 is diagnostic only. It never restarts adbd.
echo.
exit /b 0
