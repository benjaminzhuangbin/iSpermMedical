/**
 * @file config.h
 * @brief Configuration for Nexus ADB Watchdog Version 2.4.
 */
...
#define WATCHDOG_VERSION_STR        "Nexus ADB Watchdog 2.4"
#define WATCHDOG_VERSION_NUM        "2.4.0"
...
/** Seconds CLOSE_WAIT fault must persist before Case C recovery. */
