/**
 * @file inject.h
 * @brief Safe test inject file for simulating CASE A / B / C / D.
 */
 ...
 *   STOP_ADBD           - ctl.stop adbd  (CASE A)
 *   BREAK_PORT          - clear TCP port + restart adbd (CASE B / C)
 *   CLEAR_TCP_PORT      - clear persist.adb.tcp.port (CASE C)
 *   ADB_PROTOCOL_FAULT  - sticky protocol fault flag (CASE D)
 *
